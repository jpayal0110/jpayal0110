...
**Software engineer** with experience in **data engineering** and a growing interest in **AI/ML**  
**2.5+** years of industry experience at Dassault Systèmes

I build backend and full-stack systems with a strong focus on data, scalability, and real-world use cases. My work involves designing APIs, working with data pipelines, and supporting product decisions through reliable engineering.  

Lately, I’ve been exploring **applied AI and GenAI features**, including how models fit into production workflows, how data quality affects outcomes, and how to evaluate whether AI actually improves a product. I like to challenge myself with building systems that are observable, maintainable, and useful in practice.
...
- **[WebRTC Ball Tracking](https://github.com/jpayal0110/webrtc-ball-tracking.git)**  
  Real-time ball tracking system using WebRTC and WebTransport over QUIC, focused on low-latency streaming and live state synchronization.

- **[VibeCheck](https://github.com/jpayal0110/vibecheck)**  
  Music recommendation system that matches user mood using audio feature analysis and NLP-based input processing.

- **[EnrollAI](https://github.com/jpayal0110/EnrollAI)**  
  AI-driven course advisor platform built with Python and machine learning, integrated with a full-stack web interface.

- **[Cloud-Native WebApp](https://github.com/jpayal0110/cloud-native-webapp)**  
  RESTful Node.js application deployed on AWS with CI/CD via GitHub Actions, integrated with S3, RDS, and CloudWatch.

- **[Terraform AWS Infrastructure](https://github.com/jpayal0110/terraform-aws-infra)**  
  Scalable AWS infrastructure provisioned using Terraform, covering VPC, EC2, RDS, ALB, S3, IAM, and monitoring.

---

# 📊 Featured Projects (Data & Analytics)

- **[Supplier Performance Tracker](https://github.com/jpayal0110/business-kpi-visualization.git)**  
  Business KPI dashboard analyzing supplier performance to support operational and sourcing decisions.

- **[Google Apps Script – Automated Sheet Sync Tool](https://github.com/jpayal0110/sheet-sync-tool.git)**  
  Automation tool to sync and transform data across Google Sheets using Google Apps Script.

- **[Geo Stock Tracker](https://github.com/jpayal0110/geo-stock-tracker.git)**  
